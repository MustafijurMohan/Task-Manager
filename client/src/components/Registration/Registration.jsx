              ...
              <div className="card-body">
                ...
                <div className="container-fluid m-0 p-0">
                  <div className="row m-0 p-0">
                    ...
                    <div className="col-md-4 p-2">
                      ...
                      <input ref={(input) => emailRef=input} type="email" className='form-control animated fadeInUp' placeholder='User Eamil' />
                    </div>
                ...
                <div className="row mt-2 p-0">
                    <div className="col-md-4 p-2 w-100">
                      <button onClick={onRegistration} className='btn btn-primary mt-3 w-100 animated fadeInUp float-end'>Next</button>
                    </div>
                </div>
